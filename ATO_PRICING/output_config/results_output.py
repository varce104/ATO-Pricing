...
from output_config.heatmap import plot_instance_decisions
from output_config.boxplot import plot_boxplot
from output_config.candlestick import plot_candlestick
...
def export(show_sol, show_heatmap, show_boxplot, show_candlestick, vals):
    ...
    if lambda_app and Model == "MS_linear_affine":
        export_solution_to_excel_affine(f"var_results/MS_lambda_app_inst{seed}.xlsx", w_vars, time, scenarios, len(price), A)
        return None
    else:
        pass
